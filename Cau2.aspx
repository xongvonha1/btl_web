<%@ Page Title="" Language="C#" MasterPageFile="~/codeALL.Master" AutoEventWireup="true" CodeBehind="Cau2.aspx.cs" Inherits="BTLweb.WebForm10" %>
    ...
    <form method="post">
        ...
        <div class="form-group">
            ...
            <ul class="condition-list" style="list-style-type: none; padding: 0;">
                ...
                <li class="condition-item" id="number-condition">Bắt đầu bằng 3 chữ số</li>
                
            </ul>
        </div>
        <button type="submit" class="BtnDangKy" name="btnSignUp" value="true">Đăng nhập</button>
